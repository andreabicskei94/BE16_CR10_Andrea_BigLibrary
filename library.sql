...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2022 at 06:30 AM
...
CREATE TABLE `library` (
  ...
  `status` enum('avaliable','reserved') DEFAULT 'avaliable',
...
INSERT INTO `library` (`library_id`, `title`, `photo`, `isbnean`, `type`, `autor_first_name`, `autor_last_name`, `publisher_name`, `publisher_addres`, `publisher_date`, `status`, `short_description`) VALUES
...
(2, 'Scarface', 'scarface.jpg', 95882365, 'MOVIE', 'Oliver', 'Stone', ' MCA Home Video ', 'L.A', 1982, 'avaliable', 'In 1980 Miami, a determined Cuban immigrant takes over a drug cartel and succumbs to greed.'),
(3, 'Lord Of The Rings', 'lordof.jpg', 55896332, 'BOOK', 'J.R.R.', 'Tolkien', 'Mariners Book', 'Bilbo Street 15', 1993, 'avaliable', 'A meek Hobbit from the Shire and eight companions set out on a journey to destroy the powerful One Ring and save Middle-earth from the Dark Lord Sauron.'),
...
--
ALTER TABLE `library`
  MODIFY `library_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
COMMIT;
